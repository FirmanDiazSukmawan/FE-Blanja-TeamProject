...
import { getProductId, loadingSelector, productSelector } from "../../redux/reducer/productSlice";
          ...
          <div className="row">
            <section className="col-lg-4">
              <div className="model container ">
                <img src={products?.image_product} className="rounded img-fluid" alt="" style={{width:"30vh"}} />
              </div>
          ...
          >
            {products?.size?.split(",").map((size, index) => (
              ...
              <div className="button d-flex mt-4" id={style.action}>
                ...
                <button onClick={handleAddBag} type="button" class="btn btn-danger me-2 flex-grow-1">
                  Buy Now
                </button>
              </div>
            </section>
